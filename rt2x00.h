...
struct rt2x00lib_ops {
	 ...
	 */
	void (*tx0damdone_tasklet) (unsigned long data);
	void (*tx1damdone_tasklet) (unsigned long data);
	void (*tx2damdone_tasklet) (unsigned long data);
	void (*tx3damdone_tasklet) (unsigned long data);
...
struct rt2x00_dev {
	 ...
	 */
	struct tasklet_struct tx0damdone_tasklet;
	struct tasklet_struct tx1damdone_tasklet;
	struct tasklet_struct tx2damdone_tasklet;
	struct tasklet_struct tx3damdone_tasklet;
